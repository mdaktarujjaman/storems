						...
						<div class="col-sm-9 border-start border-warning"><!--Start Right-->
							<div class="container p-4 m-4">
								...
								<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="GET">
									...
									<input type="number" class="form-control" name = "spend_product_quentity" value="<?php echo $spend_product_quentity ;?>" >
									<label class="form-label">Store Entry Date:</label>
									<input type="date" class="form-control" name="spend_product_entry_date" value="<?php echo $spend_product_entry_date;?>"><br>
