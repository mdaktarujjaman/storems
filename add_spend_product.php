							...
							<div class="container p-4 m-4">
								<?php
									...
									if($conn->query($sql) == True){
										echo "New Spend Product successfully";
									} else {
								...
								<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="GET">
									...
									<input type="text" class="form-control" name = "spend_product_quentity">
									<label class="form-label">Spend Entry Date:</label>
									<input type="date" class="form-control" name="spend_product_entry_date"><br>
